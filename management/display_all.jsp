...
<%@page import="StudentDB.Display,java.sql.*" %>
<html>
<head>
...
<%
	String choice=request.getParameter("disp_choice");
	String order=request.getParameter("disp_order");
	Display obj = new Display();
	ResultSet rs= obj.display_all(choice,order);
	while(rs.next())
